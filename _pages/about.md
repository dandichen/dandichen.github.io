...
The proof affrims that appropriate $$A$$, $$Y$$ and $$C$$ are needed to identify the causal effect of interest, under a series of assumptions mentioned earlier. Because of the linearity of expectation, average treatment effect $$E[Y(A = 1) - Y(A = 0)] = E[Y(A = 1)] - E[Y(A = 0)] = E[E[Y \mid A = 1, C]] - E[E[Y \mid A = 0, C]]$$. If assuming each individual in the target population is equally likely of being sampled in this study, the defined population average treatment effect $$E[Y(A = 1) - Y(A = 0) \mid S = 1] = E[Y(A = 1) - Y(A = 0)] = E[E[Y \mid A = 1, C]] - E[E[Y \mid A = 0, C]]$$.
